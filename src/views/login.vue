  ...
  <div class="login-wrap">
    <el-form label-position="left" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0px" class="demo-ruleForm login-container">
     ...
     <!-- <el-row>
	  ...
	  <el-form-item style="width:100%;">
	    <el-button type="primary" style="width:100%;" @click="dialogVisible = true" :loading="Registerloading">注册</el-button>
	  </el-form-item>
    </el-form>
  </div>
  <el-dialog
    ...
    <span>
  		<el-form :model="registerForm" :rules="rules" ref="registerForm" label-width="100px" class="demo-ruleForm">
  		  ...
  		  <el-form-item>
  		    <el-button type="primary" @click="register(registerForm)">立即创建</el-button>
          ...
          login(this.ruleForm).then(res => {
            if (res.code == 200) {
              ...
              setTimeout(() => {
                this.logining = false
                // 缓存token
                // localStorage.setItem('logintoken', Authorization)
                // 缓存用户个人信息
